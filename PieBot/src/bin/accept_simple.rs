...
fn solve_simple(
    ...
    let mut p = piebot::search::alphabeta_simple::SearchParams::default();
    p.depth = depth;
    p.use_tt = true;
...
fn main() {
    ...
    println!("summary: cases={} elapsed={:.3}s avg_ms={:.1} nodes={} nps={:.1} fallback_hits={} start_d={} max_d={} threads={} opts=simple",
...
mod tests {
    ...
    fn missing_acceptance_suite_is_an_error() {
        assert!(load_jsonl("/definitely/missing/piebot-simple-suite.jsonl").is_err());
    }
}
