...
fn solve_alphabeta(fen: &str, depth: u32, threads: usize, max_nodes: Option<u64>) -> piebot::search::alphabeta::SearchResult {
...
fn main() {
    ...
    println!("summary: cases={} elapsed={:.3}s avg_ms={:.1} nodes={} nps={:.1} fallback_hits={} start_d={} max_d={} threads={} opts=alphabeta",
